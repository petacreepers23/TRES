...
cargar_kernel:
    ...
    ;[cluster_of_kernel]= [[cluster_of_kernel]*2 +2 + dirreccion]
	; Cargamos la dir sig de la fat

	
	
	;despues leo el siguiente elemento de la fat (el siguiente nº de cluster)
	mov word ax, [cluster_of_kernel]
	...
	;si no era eof volvemos a leerNsector ahi arriba
...
;---
msgkernelCargado: db 'Kernel cargado ',13,10,0
msgRootEncontrado: db 'root entry encontrado',13,10,0

debugmsg:      db 'debug ', 13,10,0
